	...
	<div id="wrapper" class="clearfix">
		...
		<section id="content">
			<div class="content-wrap">
				...
				<a href="icons.html" class="btn btn-secondary btn-lg btn-block mx-auto topmargin" style="max-width: 20rem;">See Available Icons <i class="icon-line-arrow-right ml-2" style="position: relative; top: 1px;"></i></a>
