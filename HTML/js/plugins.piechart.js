...
SEMICOLON._roundedSkillInit = function( $roundedSkillEl ){
				...
				entries.forEach((entry) => {
					if (entry.isIntersecting) {
						if (!element.hasClass('skills-animated')) {
							...
							SEMICOLON._runRoundedSkills( element, properties );
...
SEMICOLON._runRoundedSkills = function( element, properties ){
